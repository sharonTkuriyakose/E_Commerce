...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-border pt-24 pb-12 overflow-hidden shadow-2xl">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8 mb-20 border-b border-border pb-24">
          ...
          <div className="lg:col-span-5 space-y-10">
            <Link to="/" className="flex items-center gap-3 shrink-0">
               <div className="w-12 h-12 rounded-sm bg-primary flex items-center justify-center font-black text-white text-2xl uppercase tracking-tighter shadow-sm" style={{ fontFamily: 'Inter' }}>T</div>
               <span className="text-2xl font-black tracking-tighter text-primary uppercase" style={{ fontFamily: 'Inter' }}>TECH<span className="text-accent underline decoration-4 underline-offset-4 decoration-accent/20 ml-2">STORE</span></span>
            </Link>
            ...
            <div className="space-y-6">
               ...
               <div className="flex gap-4 pt-4">
                  {[Instagram, Twitter, Linkedin, Youtube].map((Icon, idx) => (
                    <button key={idx} className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-muted hover:text-accent hover:border-accent transition-all">
          ...
          <div className="lg:col-span-3 space-y-8">
            <h3 className="text-[11px] font-black text-primary uppercase tracking-[0.4em]">Store Nav</h3>
            <ul className="space-y-4">
              {['Smartphones', 'Laptops', 'Audio Gear', 'Wearables', 'New Arrivals'].map((link) => (
                <li key={link}>
                  <Link to="/products" className="text-xs font-bold text-text-secondary hover:text-accent transition-colors flex items-center gap-2 group italic">
          ...
          <div className="lg:col-span-4 space-y-8">
            <h3 className="text-xs font-black text-primary uppercase tracking-[0.3em]">Support Hub</h3>
            <div className="space-y-4 pt-2">
               ...
               <div className="flex items-center gap-4 text-xs font-bold text-text-secondary">
                  ...
                  <span>Global Tech HQ, Mumbai, India</span>
               </div>
            </div>
            ...
            <div className="pt-8 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-2 opacity-50 justify-center">
                 ...
                 <span className="text-[9px] font-black text-primary uppercase tracking-widest leading-none">100% Encrypted Transactions</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-4">
          <div className="flex items-center gap-8 text-[10px] font-black uppercase tracking-widest text-text-muted opacity-80">
